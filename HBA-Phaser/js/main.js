...
function preload(){
    ...
    game.load.image('grass:8x1', 'images/grass_8x1b.png');
    game.load.image('grass:6x1', 'images/grass_6x1b.png');
    game.load.image('grass:4x1', 'images/grass_4x1b.png');
    game.load.image('grass:2x1', 'images/grass_2x1b.png');
    game.load.image('grass:1x1', 'images/grass_1x1b.png');

    // load the hero image=
    game.load.image('hero', 'images/hero_stopped1.png');
    ...
    game.load.image('spider', 'images/spider1.png');
    game.load.image('invisible-wall', 'images/invisible_wall.png');
    game.load.image('icon:coin', 'images/coin_icon1.gif');
